...
> 爱莉的生命域：持续心跳、潜意识、意识实例、记忆、学习、好奇心、自主意向、使命编排与具身体验。
...
`CuriosityEngine` 异步审阅尚未理解的内容，形成轻量注意牵引，并把结果写入好奇状态。它提供“值得再看一眼”的信号，不强制主体行动。

...
# MEMORY.md 管理
MEMORY_PROMPT_SOFT_LIMIT_BYTES: int = 8 * 1024
MEMORY_WRITE_WARNING_THRESHOLD_BYTES: int = 10 * 1024
MEMORY_MAX_DURABLE_ITEMS: int = 40
MEMORY_MAX_FADING_ITEMS: int = 3
MEMORY_CHATTER_MAX_DURABLE_ITEMS: int = 18
MEMORY_CHATTER_MAX_ACTIVE_ITEMS: int = 6

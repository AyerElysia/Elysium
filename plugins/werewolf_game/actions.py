"""Life-chatter facing player action for Werewolf v2.0."""
...
class WerewolfPlayerAction(BaseAction):
    ...
    action_description = (
        ...
        "不会暴露裁判全量身份表。\n"
        "action 可用：view/join/kill/check/heal/poison/guard/pass/vote/自爆/竞选/开枪/遗言。"
    )
    ...
    async def execute(
        self,
        action: Annotated[str, "动作：view/join/kill/check/heal/poison/guard/pass/vote/自爆/竞选/开枪/遗言"],

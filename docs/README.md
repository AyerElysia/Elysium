...
- [principles.md](./principles.md) — 主体性、零规则、仿生、边界提醒（必读）

## 设计哲学

- [智能不是模型而是系统](./philosophy/智能不是模型而是系统.md)
- [SNN 与系统智能：深度思考](./philosophy/SNN_与系统智能_深度思考.md)
...
- [Phase5: 支撑材料](./architecture/Phase5_SupportingMaterials/)
- [Phase6: 实践材料](./architecture/Phase6_PracticeMaterials/)
...
- [下一步计划](./minecraft/minecraft_next_steps.md)
- [审查总结](./minecraft/minecraft_review_summary.md)
...
- [archive/](./archive/) — 开发报告、审计记录（2026-03 至 2026-07，不代表当前状态）

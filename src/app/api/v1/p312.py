"""P3-12 主体观察、计划与能力公共 Facade。

Router 只处理 HTTP 合同；领域 owner 通过 ``P312Providers`` 注入，
因此 API 层不会创建第二套意识或记忆状态。
"""
...
__all__ = ["P312Providers", "create_p312_router"]
